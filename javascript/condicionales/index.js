var excersice
//variables globales de los ejercicios
var primerNumero, segundoNumero, tercerNumero, precio, duracion, meses

selectionExcersice()

function selectionExcersice(){
    document.open()
    document.write('<h1>Selecciona que ejercicio deseas</h1><form id="excercises"><input type="radio"  onclick=eresBellisimo()> 1.- ¿Eres bellismo?<br><input type="radio"  onclick=divisible()> 2.- Numero divisible entre dos<br><input type="radio"  onclick=par()> 3.- Numero par o impar<br><input type="radio"  onclick=premioCliente()> 4.- Numero de cliente<br><input type="radio"  onclick=menorQue()> 5.- Numero menor de 2<br><input type="radio"  onclick=menorQueTres()> 6.- Numero menor de 3<br><input type="radio"  onclick=semana()> 7.- Dia de la semana<br><input type="radio"  onclick=calificaciones()> 8.- Calificaciones<br><input type="radio" onclick=helado()> 9.- Helados y toppings<br><input type="radio" onclick=cursos()> 10.- Precio de tu curso<br><input type="radio" onclick=kilometros()> 11.- Kilometros y vehiculos<br></form>')
}

function terminar(){
    document.write('<br><br><br><br><br><input type="radio"  onclick=selectionExcersice()>da click cuando termines<br>')
}
...
function menorQue(){
    document.open()
    primerNumero = prompt('Dame un primer número')
    segundoNumero = prompt('Dame un segundo número')
...
function menorQueTres(){
    ...
    primerNumero = prompt('Dame un primer número')
    segundoNumero = prompt('Dame un segundo número')
    tercerNumero = prompt('Dame un tercer número')
...
//ejercicio curso y las dos funciones que usa
function cursos(){
    document.open()
...
/* base para acomodar el document.write
<h1>Selecciona que ejercicio deseas</h1>
<form id="excercises">
    <input type="radio" onclick=kilometros()> 11.- Kilometros y vehiculos<br>
</form>

codigo para la funcion temrinar
document.write('<input type="radio"  onclick=selectionExcersice()><br><br><br>da click cuando termines<br>')
}
*/